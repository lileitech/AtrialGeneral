...
class RandomNoise(object):
    def __init__(self, mu=0, sigma=0.8):
        self.mu = mu
        self.sigma = sigma
    ...
    def __call__(self, image):
        ...
        # image = exposure.adjust_gamma(image, (0.5, 1.5)
...
def LoadDataset3d(imagenames, labelnames, DA = False, hist_matching = False):
...
def LoadDataset2d(imagename, labelname, DA = True, hist_matching = True):
    numpy2Dimage = []
    numpy2Dlabel = []
    NumSlice = 0
    ...
    if DA == False:        
        ...
        numpyimage_new, numpylabel_new = DataPreprocessing3d(numpyimage, numpylabel) 
    if hist_matching == True:
        refimagename = '/home/lilei/Workspace/AtrialGeneral2021/Data/KCL_1/Post/train_data/p1/'
        numpyimage_ref = Loadimage(refimagename + 'enhanced.nii.gz')
        numpylabel_ref = Loadimage(refimagename + 'atriumSegImgMO.nii.gz')
